              ...
              <div className="flex flex-row items-center gap-2">
                {book.pdf_link && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="font-display inline-flex items-center gap-3 px-6 py-3 rounded-xl bg-black text-white hover:bg-gray-800 transition shadow-sm"
                  >
                    <Download size={20} />
                ...
                <button
                  ...
                  className="font-display inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-black text-white hover:bg-gray-800 transition shadow-sm"
                >
                  <Share2 />
                </button>
              </div>
              ...
              {book.tags?.length > 0 && (
                <div className="flex flex-wrap gap-2 pt-2">
                  {book.tags.slice(0, 6).map((tag, i) => (
                    <span
                      key={i}
                      className="text-xs px-3 py-1 rounded-full bg-white border border-gray-200 text-gray-600 hover:border-gray-400 hover:text-black transition"
                    >
                      #{tag}
                    </span>
                  ))}
